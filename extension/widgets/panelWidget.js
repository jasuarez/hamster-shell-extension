...
var PanelWidget = new Lang.Class({
    ...
    _refreshExpectedWeekStatus: function([response], err) {
        ...
        this.isTimeDone(weekOfDay * MINUTES_PER_DAY * 60, currentWeek, 'panel-box-daydoneweeknot');
    },
    ...
    setDayTimeDone: function(totalTime) {
        this.isTimeDone(totalTime, MINUTES_PER_DAY * 60, 'panel-box-daydone');
        if (totalTime >= MINUTES_PER_DAY * 60) {
            this._controller.apiProxy.GetFactsRemote(this._startOfWeek(),
                                                     this._endOfToday(),
                                                     "",
    ...
    setWeekTimeDone: function(totalTime) {
        this.isTimeDone(totalTime, MINUTES_PER_WEEK * 60, 'panel-box-weekdone');
    },
